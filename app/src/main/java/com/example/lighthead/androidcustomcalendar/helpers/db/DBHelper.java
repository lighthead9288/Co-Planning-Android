...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static final int DBVERSION = 10; // версия базы данных
    ...
    public static final String COLUMN_ServerTaskNumber = "ServerTaskNumber";
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        try {
            ...
            db.execSQL("INSERT INTO " + TABLE+"_backup" +" SELECT " + COLUMN_ID + ","+
                                                                            ...
                                                                            COLUMN_Complete +","+
                                                                            COLUMN_DateTo+","+
                                                                            COLUMN_TimeTo+  " FROM "+TABLE + ";");
            db.execSQL("ALTER TABLE " + TABLE+"_backup" +" ADD COLUMN " + COLUMN_ServerTaskNumber+ " TEXT");
            ...
            for(userCursor.moveToFirst(); !userCursor.isAfterLast(); userCursor.moveToNext()) {
                ...
                String serverTaskNumber = userCursor.getString(userCursor.getColumnIndex(DBHelper.COLUMN_ServerTaskNumber));
